...
| **B** | `src-tauri/src/evolution/`, `src-tauri/src/ledger/` | Sandbox/fuzzing, the three ledgers |
...
- **`src-tauri/Cargo.toml`** and **`landing/package.json`** — dependency lists. Add your
  crate/package on its own line; merge these PRs promptly.
